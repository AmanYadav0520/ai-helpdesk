...
import { LayoutDashboard, LogOut, Moon, Sun, Ticket, Users } from "lucide-react";
...
export function NavBar() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-background border-b px-6 h-14 flex items-center justify-between">
      ...
      <div className="flex items-center gap-1">
        ...
        <span className="text-[13px] text-muted-foreground mr-1">{session?.user.name}</span>
        <button
          type="button"
